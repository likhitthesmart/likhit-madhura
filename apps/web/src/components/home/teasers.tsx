...
export function HeritageTeaser() {
  return (
    <section className="relative overflow-hidden bg-forest-950 py-0">
      <div className="grid lg:grid-cols-2">
        <div className="relative min-h-[380px] lg:min-h-[560px]">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-transparent to-forest-950/60 lg:to-forest-950" />
        </div>
        <div className="flex items-center bg-forest-950 px-8 py-16 sm:px-14">
          <Reveal>
